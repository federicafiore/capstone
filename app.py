...
st.subheader('Likes Received Deep Dive')
...
with col2:
    fig = plt.figure()
    sns.barplot(data=df, x='location_type', y='likes_received')
    plt.title('Average Likes Received by Location')
    plt.xticks(rotation=45)
    plt.tight_layout()
    st.pyplot(fig)
...
with col1:
    fig = plt.figure()
    sns.barplot(data=df, x='education_level', y='likes_received')
    plt.title('Average Likes Received by Education Level')
    plt.xticks(rotation=45)
    plt.tight_layout()
    st.pyplot(fig)
...
with col2:
    fig = plt.figure()
    sns.barplot(data=df, x='age_group', y='likes_received')
    plt.title('Average Likes Received by Age Group')
    plt.xticks(rotation=45)
    plt.tight_layout()
    st.pyplot(fig)
...
if submit:
    ...
    st.text(f"These results are only probabilistic.")
